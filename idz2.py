...
# Использование переменной окружения STUDENTS_DATA_FILE или значения по умолчанию
data_file = os.getenv('STUDENTS_DATA_FILE', 'students_data.txt')
...
def main():
    ...
    parser.add_argument('--data-file', type=str, default=data_file, help='Имя файла данных (по умолчанию: students_data.txt)')
